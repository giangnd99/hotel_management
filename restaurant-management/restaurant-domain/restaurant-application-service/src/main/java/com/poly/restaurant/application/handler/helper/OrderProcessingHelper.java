...
import com.poly.restaurant.management.publisher.PaymentRequestPublisher;
import com.poly.restaurant.management.publisher.RoomOrderRequestPublisher;
...
public class OrderProcessingHelper {
    ...
    private final RoomOrderRequestPublisher roomOrderRequestPublisher;
    ...
    public void triggerRoomOrderRequest(OrderDTO orderDTO, String roomId) {
        ...
        try {
            ...
            RoomOrderRequestMessage roomOrderRequestMessage = RoomOrderMessageHelper.createAttachOrderRequest(
                    orderDTO.id(),
                    roomId,
                    orderDTO.customerId(),
                    totalAmount.toString()
    ...
    public void triggerRoomOrderPaymentRequest(OrderDTO orderDTO, String roomId) {
        ...
        try {
            ...
            RoomOrderRequestMessage detachRequestMessage = RoomOrderMessageHelper.createDetachOrderRequest(
                    orderDTO.id(),
                    roomId,
                    orderDTO.customerId()
            );
