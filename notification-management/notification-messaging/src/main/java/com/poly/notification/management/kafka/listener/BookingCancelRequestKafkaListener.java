...
public class BookingCancelRequestKafkaListener implements KafkaConsumer<NotificationMessageAvro> {
    ...
    private final String TOPIC_NAME = "booking-cancel-email-topic";

    @Override
    @KafkaListener(topics = TOPIC_NAME, groupId = "notification-cancel-mail-request")
    public void receive(
