...
public class BookingPaymentSaga implements SagaStep<PaymentMessageResponse> {
    ...
    public void process(PaymentMessageResponse paymentResponse) {
        ...
        BookingDepositedEvent domainEvent = executePaymentCompletion(paymentResponse);
     ...
     */
    private BookingDepositedEvent executePaymentCompletion(PaymentMessageResponse paymentResponse) {
     ...
     */
    private void triggerRoomReservationStep(BookingDepositedEvent domainEvent, String sagaId) {
     ...
     * @return BookingPaidEvent domain event
     */
    private BookingDepositedEvent completePaymentForBooking(PaymentMessageResponse data) {
