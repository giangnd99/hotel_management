...
/**
 * Kafka Publisher chịu trách nhiệm gửi yêu cầu thanh toán đặt cọc (deposit payment request)
 * đến Kafka topic để xử lý thanh toán.
 * 
...
@Slf4j
public class DepositPaymentRequestKafkaPublisher implements DepositPaymentRequestMessagePublisher {
    ...
    /**
     * Gửi yêu cầu thanh toán đặt cọc đến Kafka topic
     * 
    ...
    private void handleProcessingError(PaymentEventPayload paymentEventPayload,
        ...
        // throw new PaymentRequestPublishingException("Không thể gửi payment request", exception);
    }
}
