...
public class BeanConfig {
    ...
    @Bean
    public PaymentUsecase paymentUsecase(PaymentRepository paymentRepository, PaymentGateway payOS) {
        return new PaymentApplicationService(paymentRepository, payOS);
    }
}
