...
INSERT INTO rooms (room_id, room_type_id, room_number, floor, area, room_status, image_url) VALUES
                                                                                                (gen_random_uuid(), (SELECT room_type_id FROM room_types WHERE type_name='Standard Room'),     '101', 1, '28m2', 'VACANT',      'https://picsum.photos/200/300'),
                                                                                                (gen_random_uuid(), (SELECT room_type_id FROM room_types WHERE type_name='Standard Room'),     '102', 1, '28m2', 'BOOKED',      'https://picsum.photos/200/300'),
                                                                                                (gen_random_uuid(), (SELECT room_type_id FROM room_types WHERE type_name='Standard Room'),     '103', 1, '30m2', 'CHECKED_IN',  'https://picsum.photos/200/300'),
                                                                                                (gen_random_uuid(), (SELECT room_type_id FROM room_types WHERE type_name='Standard Room'),     '104', 1, '30m2', 'MAINTENANCE', 'https://picsum.photos/200/300'),

                                                                                                (gen_random_uuid(), (SELECT room_type_id FROM room_types WHERE type_name='Deluxe Room'),       '201', 2, '35m2', 'CLEANING',    'https://picsum.photos/200/300'),
                                                                                                (gen_random_uuid(), (SELECT room_type_id FROM room_types WHERE type_name='Deluxe Room'),       '202', 2, '35m2', 'CHECKED_OUT', 'https://picsum.photos/200/300'),
                                                                                                (gen_random_uuid(), (SELECT room_type_id FROM room_types WHERE type_name='Deluxe Room'),       '203', 2, '38m2', 'VACANT',      'https://picsum.photos/200/300'),
                                                                                                (gen_random_uuid(), (SELECT room_type_id FROM room_types WHERE type_name='Deluxe Room'),       '204', 2, '38m2', 'VACANT',      'https://picsum.photos/200/300'),

                                                                                                (gen_random_uuid(), (SELECT room_type_id FROM room_types WHERE type_name='Suite Room'),        '301', 3, '50m2', 'VACANT',      'https://picsum.photos/200/300'),
                                                                                                (gen_random_uuid(), (SELECT room_type_id FROM room_types WHERE type_name='Suite Room'),        '302', 3, '52m2', 'VACANT',      'https://picsum.photos/200/300'),
                                                                                                (gen_random_uuid(), (SELECT room_type_id FROM room_types WHERE type_name='Suite Room'),        '303', 3, '55m2', 'VACANT',      'https://picsum.photos/200/300'),
                                                                                                (gen_random_uuid(), (SELECT room_type_id FROM room_types WHERE type_name='Suite Room'),        '304', 3, '55m2', 'VACANT',      'https://picsum.photos/200/300'),

                                                                                                (gen_random_uuid(), (SELECT room_type_id FROM room_types WHERE type_name='Executive Room'),    '401', 4, '65m2', 'VACANT',      'https://picsum.photos/200/300'),
                                                                                                (gen_random_uuid(), (SELECT room_type_id FROM room_types WHERE type_name='Executive Room'),    '402', 4, '68m2', 'VACANT',      'https://picsum.photos/200/300'),
                                                                                                (gen_random_uuid(), (SELECT room_type_id FROM room_types WHERE type_name='Executive Room'),    '403', 4, '70m2', 'VACANT',      'https://picsum.photos/200/300'),
                                                                                                (gen_random_uuid(), (SELECT room_type_id FROM room_types WHERE type_name='Executive Room'),    '404', 4, '70m2', 'VACANT',      'https://picsum.photos/200/300'),

                                                                                                (gen_random_uuid(), (SELECT room_type_id FROM room_types WHERE type_name='Presidential Suite'),'501', 5, '120m2', 'VACANT',     'https://picsum.photos/200/300'),
                                                                                                (gen_random_uuid(), (SELECT room_type_id FROM room_types WHERE type_name='Presidential Suite'),'502', 5, '125m2', 'VACANT',     'https://picsum.photos/200/300'),
                                                                                                (gen_random_uuid(), (SELECT room_type_id FROM room_types WHERE type_name='Presidential Suite'),'503', 5, '130m2', 'VACANT',     'https://picsum.photos/200/300'),
                                                                                                (gen_random_uuid(), (SELECT room_type_id FROM room_types WHERE type_name='Presidential Suite'),'504', 5, '135m2', 'VACANT',     'https://picsum.photos/200/300');
