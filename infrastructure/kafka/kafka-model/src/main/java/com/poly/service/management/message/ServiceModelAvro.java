...
public class ServiceModelAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static ServiceModelAvro.Builder newBuilder() {
    return new ServiceModelAvro.Builder();
  }
   ...
   * @return A new ServiceModelAvro RecordBuilder
   */
  public static ServiceModelAvro.Builder newBuilder(ServiceModelAvro.Builder other) {
    if (other == null) {
      return new ServiceModelAvro.Builder();
    } else {
      return new ServiceModelAvro.Builder(other);
    }
  }
   ...
   * @return A new ServiceModelAvro RecordBuilder
   */
  public static ServiceModelAvro.Builder newBuilder(ServiceModelAvro other) {
    if (other == null) {
      return new ServiceModelAvro.Builder();
    } else {
      return new ServiceModelAvro.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ServiceModelAvro>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ServiceModelAvro.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ServiceModelAvro other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.serviceId)) {
        this.serviceId = data().deepCopy(fields()[0].schema(), other.serviceId);
    ...
    /**
      ...
      * @return This builder.
      */
    public ServiceModelAvro.Builder setServiceId(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ServiceModelAvro.Builder clearServiceId() {
      serviceId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ServiceModelAvro.Builder setServiceName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ServiceModelAvro.Builder clearServiceName() {
      serviceName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ServiceModelAvro.Builder setDescription(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ServiceModelAvro.Builder clearDescription() {
      description = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ServiceModelAvro.Builder setPrice(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ServiceModelAvro.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ServiceModelAvro.Builder setAvailability(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ServiceModelAvro.Builder clearAvailability() {
      availability = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ServiceModelAvro.Builder setCreatedAt(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ServiceModelAvro.Builder clearCreatedAt() {
      createdAt = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ServiceModelAvro.Builder setUpdatedAt(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ServiceModelAvro.Builder clearUpdatedAt() {
      updatedAt = null;
